...
async function loadAccountPanel() {
  ...
  if (canAudit) {
    const identityAuditLabels = { 'workspace.renamed': '重命名工作区', 'user.profile_updated': '更新个人资料', 'feedback.created': '提交试点反馈', 'feedback.promoted': '反馈转为验收标准', 'feedback.status_changed': '更新反馈状态', 'feedback.reopened': '重新打开反馈', 'feedback.verified_by_run': '验收证据关闭反馈', 'feedback.exported': '导出试点反馈' };
