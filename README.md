...
> 当前版本：`0.4.0-dev.8`。已具备真实浏览器验收、证据返工闭环、安全工作区、完整成员生命周期、运行状态监控、PostgreSQL 灾备、哈希链审计、CI/CD 发布门禁、可校验交付包、受保护的密钥轮换与回退，以及默认拒绝未授权出站目标的安全执行边界。正式公网部署仍需 HTTPS 和外部安全审查。
