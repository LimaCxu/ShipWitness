...
export class BackupManager {
  constructor({ databaseUrl, artifactsDir, backupRoot, version, schemaVersion }) {
    this.databaseUrl = databaseUrl || null; this.artifactsDir = resolve(artifactsDir); this.backupRoot = resolve(backupRoot); this.version = version; this.schemaVersion = schemaVersion;
  }
