...
const collections = ['workspaces', 'users', 'memberships', 'sessions', 'mfaChallenges', 'passwordResets', 'apiKeys', 'idempotencyRecords', 'securityReviews', 'securityFindings', 'signedSecurityReviews', 'recoveryDrills', 'projects', 'projectSelections', 'contracts', 'runs', 'issues', 'decisions', 'pilotFeedback', 'auditEvents', 'signedDossiers', 'webhooks', 'webhookDeliveries', 'emailDeliveries', 'githubDeliveries', 'alerts', 'auditExports', 'invitations', 'inboxReads'];
