...
const collections = ['workspaces', 'users', 'memberships', 'sessions', 'apiKeys', 'idempotencyRecords', 'securityReviews', 'securityFindings', 'signedSecurityReviews', 'projects', 'projectSelections', 'contracts', 'runs', 'issues', 'decisions', 'pilotFeedback', 'auditEvents', 'signedDossiers', 'webhooks', 'webhookDeliveries', 'emailDeliveries', 'githubDeliveries', 'alerts', 'auditExports', 'invitations', 'inboxReads'];
