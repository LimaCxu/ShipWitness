...
const collections = ['workspaces', 'users', 'memberships', 'sessions', 'apiKeys', 'projects', 'contracts', 'runs', 'issues', 'decisions', 'auditEvents', 'signedDossiers', 'webhooks', 'webhookDeliveries'];
