...
const collections = ['workspaces', 'users', 'memberships', 'sessions', 'apiKeys', 'idempotencyRecords', 'securityReviews', 'securityFindings', 'projects', 'projectSelections', 'contracts', 'runs', 'issues', 'decisions', 'auditEvents', 'signedDossiers', 'webhooks', 'webhookDeliveries', 'emailDeliveries', 'githubDeliveries', 'alerts', 'auditExports', 'invitations', 'inboxReads'];
