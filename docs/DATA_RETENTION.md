...
Owners select an operational-data retention period from 30 to 730 days. The policy applies only to expired sessions, terminal Webhook deliveries, and resolved alerts. ShipWitness never automatically removes audit events, acceptance runs, issues, release decisions, signed dossiers, or screenshot evidence.
